...
/// @brief RemapPrinterVisitor generates a string given an expression.
class RemapPrinterVisitor : public ExpVisitor {
public:
  ...
  /// @brief Destructor.
  ~RemapPrinterVisitor() override = default;
...
protected:
  ...
  /// @brief The target to remap
  const std::unordered_map<std::string, std::string> &_targetToRemap;
};

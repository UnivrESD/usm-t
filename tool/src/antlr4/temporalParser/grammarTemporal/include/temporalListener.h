...
public:
  ...
  virtual void enterSere_implication(temporalParser::Sere_implicationContext *ctx) = 0;
  virtual void exitSere_implication(temporalParser::Sere_implicationContext *ctx) = 0;

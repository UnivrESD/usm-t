...
void Vtbench_top___024root__trace_chg_0_sub_0(Vtbench_top___024root* vlSelf, VerilatedVcd::Buffer* bufp);

void Vtbench_top___024root__trace_chg_0(void* voidSelf, VerilatedVcd::Buffer* bufp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vtbench_top___024root__trace_chg_0\n"); );
    // Init
    ...
    // Body
    Vtbench_top___024root__trace_chg_0_sub_0((&vlSymsp->TOP), bufp);
}

void Vtbench_top___024root__trace_chg_0_sub_0(Vtbench_top___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    (void)vlSelf;  // Prevent unused variable warning
    Vtbench_top__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vtbench_top___024root__trace_chg_0_sub_0\n"); );
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Init
    uint32_t* const oldp VL_ATTR_UNUSED = bufp->oldp(vlSymsp->__Vm_baseCode + 1);
    // Body
    bufp->chgBit(oldp+0,(vlSelfRef.tbench_top__DOT__clk));
    bufp->chgBit(oldp+1,(vlSymsp->TOP__tbench_top__DOT__intf.clk));
    bufp->chgBit(oldp+2,((1U & (~ ((~ ((IData)(vlSelfRef.tbench_top__DOT__DUT__DOT___01_) 
...
void Vtbench_top___024root__trace_cleanup(void* voidSelf, VerilatedVcd* /*unused*/) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vtbench_top___024root__trace_cleanup\n"); );
    // Init
    Vtbench_top___024root* const __restrict vlSelf VL_ATTR_UNUSED = static_cast<Vtbench_top___024root*>(voidSelf);
    Vtbench_top__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
